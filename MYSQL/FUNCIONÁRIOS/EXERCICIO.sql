...
/* TRAGA OS FUNCIONARIOS QUE TRABALHAM NO DEPARTAMENTO
DE FILMES OU NO DEPARTAMENTO DE ROUPAS */


SELECT COUNT(*) FROM FUNCIONARIOS;

SELECT COUNT(*), DEPARTAMENTO /* 21 FILMES | 53 ROUPAS */
FROM FUNCIONARIOS
GROUP BY DEPARTAMENTO
ORDER BY 1; /* LISTA EM ORDEM "ALFABÉTICA" */

/* COLOCAREMOS NA PRIMEIRA CONDIÇÃO, QUEM TEM MAIS CHANCES DE UMA SAÍDA VERDADEIRA */
SELECT * FROM FUNCIONARIOS
WHERE DEPARTAMENTO = 'ROUPAS'
OR DEPARTAMENTO = 'FIMES';


/* LISTA DE FUNCIONARIOS (FEMENINO) QUE TRABALHAM 
...
SELECT * FROM FUNCIONARIOS
WHERE 
(DEPARTAMENTO = 'LAR' AND SEXO = 'FEMENINO')
OR 
(DEPARTAMENTO = 'FILMES' AND SEXO = 'FEMENINO');


/* TRAZER OS FUNCIONARIOS DO SEXO MASCULINO OU OS
FUNCIONARIOS QUE TRABALHAM NO SETOR JARDIM */
